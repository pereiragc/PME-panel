#+TITLE: Document stuff related to PME
...
Below I use ~hhid2~ as merging key between person and household datasets, and include ~hhid~ in the people data. The output of the block is a random household
