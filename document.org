...
Note that now with reasonable link between person and household data, we can recover the mislabeled state in year 1985 into the person dataset.

A final issue occurs in December 1985:
