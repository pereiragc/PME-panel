...
The key to combine person and household is to use the columns:
| Column              | Meaning                             | Availability 80s  | Availability 90s  |
|---------------------+-------------------------------------+-------------------+-------------------|
| UF [.state]         |                                     | household, person | household, person |
| MES [V(105, 2002?)] |                                     | household         | household, person |
...
Let's create a variable that flags whether month is:
