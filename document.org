...
pp_old_samp[!(ambiguous_id2), person_id2_m := person_id1]
...
*** Combining IDs
One digression that is important at this point (and at which I lost more hours than I should have) is that 
